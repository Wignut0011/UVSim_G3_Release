...
___|
	...
	Arithmetic Instructions:
		Add = 30                Add a word from a specific location in memory to the word 
					in the accumulator (leave the result in the accumulator)
									
		SUBTRACT = 31           Subtract a word from a specific location in memory from the 
		...
		MULTIPLY = 33           multiply a word from a specific location in memory to the 
					word in the accumulator (leave the result in the accumulator).
...
--------------------------------------------------------------------------------------------------
	...
	Disclaimer: To avoid any future students from plagiarizing this project, no source code will be
	            provided.
